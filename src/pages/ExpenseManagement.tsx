...
import { FiSearch, FiPlus, FiEdit2, FiArchive, FiEye, FiX, FiCheck, FiXCircle, FiClock, FiDollarSign, FiCalendar, FiUser, FiFileText, FiEyeOff, FiRotateCcw, FiImage, FiFolder, FiRotateCw, FiMessageSquare, FiMapPin } from 'react-icons/fi'
...
const ExpenseManagement: React.FC = () => {
  ...
  const filteredExpenses = expenses.filter(expense => {
    ...
    const matchesStation = filterStation === 'All' || expense.stationId === filterStation || (!expense.stationId && filterStation === 'None')
  ...
  // Sort expenses within each category based on sortBy

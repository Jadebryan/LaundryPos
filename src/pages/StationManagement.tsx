...
import { FiSearch, FiMapPin, FiEdit2, FiArchive, FiEye, FiX, FiPlus, FiRotateCcw, FiSave, FiTrash2, FiHash } from 'react-icons/fi'
...
const StationManagement: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    setIsLoading(true)
    try {
      await stationAPI.update(selectedStation._id || selectedStation.id || '', {
          ...
          <div className="stations-grid-container">
                ...
                {filteredStations.map((station) => (
                  ...
                  >
                    <div className="station-card-header">
                      ...
                      <div className={`status-badge-top ${station.isActive ? 'active' : 'inactive'}`}>
                ...
                {filteredStations.map((station, idx) => (
                  ...
                  >
                    ...
                    <div className="list-cell">
                      <span className={`status-badge-list ${station.isActive ? 'active' : 'inactive'}`}>
                        {station.isActive ? 'Active' : 'Inactive'}
                      </span>
                    </div>
                    <div className="list-cell actions">
                      <div className="action-buttons-row">
                        ...
                        <button
                          className="btn-icon-small"
                          onClick={() => { setSelectedStation(station); setIsModalOpen(true); setIsEditMode(true) }}
                          title="Edit"
                        >
                          <FiEdit2 />
                        </button>
            ...
            {filteredStations.length === 0 && (
              <div className="empty-state">
                ...
                <p>{searchTerm ? 'Try adjusting your search' : showArchived ? 'No archived stations' : 'No active stations'}</p>
              </div>
            )}
          </div>
        )}
              ...
              >
                <div className="modal-header">
                  <div>
                    ...
                    <p className="modal-subtitle">{selectedStation.stationId}</p>
                  </div>
                ...
                {isEditMode ? (
                  <div className="modal-form">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setSelectedStation({ ...selectedStation, stationId: e.target.value.toUpperCase() })}
                      />
                    </div>
                    <div className="form-group">
                      <label>Name</label>
                    ...
                    <div className="form-group">
                      ...
                      <textarea
                        ...
                        onChange={(e) => setSelectedStation({ ...selectedStation, address: e.target.value })}
                        rows={3}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setSelectedStation({ ...selectedStation, phone: e.target.value })}
                      />
                    </div>
                    <div className="form-group">
                      <label>Notes</label>
                      <textarea
                        ...
                        onChange={(e) => setSelectedStation({ ...selectedStation, notes: e.target.value })}
                        rows={3}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => setSelectedStation({ ...selectedStation, isActive: e.target.value === 'Active' })}
                      >
                  ...
                  <div className="modal-content">
                    ...
                    {selectedStation.phone && (
                      <div className="detail-card">
                        <label>Phone</label>
                        <div className="detail-value">{selectedStation.phone}</div>
                      </div>
                    )}
                    {selectedStation.notes && (
                      <div className="detail-card">
                        <label>Notes</label>
                        <div className="detail-value">{selectedStation.notes}</div>
                      </div>
                    )}
                    <div className="detail-card">
                      <label>Status</label>
                      <div className={`status-badge ${selectedStation.isActive ? 'active' : 'inactive'}`}>
